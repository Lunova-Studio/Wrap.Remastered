...
namespace Warp.Client.Services;
...
public sealed class UPnPService : IUPnPService {
    ...
    public UPnPService(Waher.Networking.UPnP.UPnPService service) {
        Service = service;
    }

    public void AddPortMapping(IPAddress? NewRemoteHost, int NewExternalPort, SocketProtocol NewProtocol, IPAddress NewInternalClient, int NewInternalPort, bool NewEnabled, string NewPortMappingDescription, TimeSpan NewLeaseDuration) {
    ...
    public async Task AddPortMappingAsync(IPAddress? NewRemoteHost, int NewExternalPort, SocketProtocol NewProtocol, IPAddress NewInternalClient, int NewInternalPort, bool NewEnabled, string NewPortMappingDescription, TimeSpan NewLeaseDuration) {
    ...
    public void DeletePortMapping(IPAddress? NewRemoteHost, int NewExternalPort, SocketProtocol NewProtocol) {
    ...
    public async Task DeletePortMappingAsync(IPAddress? NewRemoteHost, int NewExternalPort, SocketProtocol NewProtocol) {
