...
public sealed class PeerConnectRequestPacketSerializer : ISerializer<IPacket> {
    public byte[] Serialize(IPacket obj) {
        if (obj is not PeerConnectRequestPacket packet)
    ...
    public IPacket Deserialize(byte[] data) {
        ...
        var packet = new PeerConnectRequestPacket {
